...
matplot(y = t(RcticG1), type = 'p', lty = 1, pch = 16, main = NULL, ylab = "Length (m)", xlab = "Age (weeks)", las = 1, col = alpha(cols, 0.5))
...
plot(y = RcticG1ind1, x = xvalues, main = NULL, ylab = "Length (m)", xlab = "Age (weeks)", las = 1)
...
plot.new(y = RcticG1ind1, x = xvalues, main = "Polynomial Regression", ylab = "Length (m)", xlab = "Age (weeks)", las = 1)
...
```{r, fig.cap=fig$cap("Fluvial vs. Adfluial", "A comparison of male and female R-ctic Grayling lengths")}
matplot(y = t(RcticG1), type = 'p', lty = 1, pch = 10, ylab = "Length (m)", xlab = "Age (weeks)", las = 1, col = 1, ylim = c(0, 0.9))
matplot(y = t(RcticG2), type = 'p', lty = 1, pch = 1, las = 1, col = 2, add = TRUE)
legend("bottomright",c("Fluvial", "Adfluvial"), col = c("black", "red"), pch = c(10, 1))
```
...
plot(y = RcticG1ind1, x = xvalues, main = "Polynomial Regression", ylab = "Length (m)", xlab = "Age (weeks)", las = 1)
