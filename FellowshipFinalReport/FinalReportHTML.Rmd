...
matplot(y = t(RcticG1), type = 'p', lty = 1, pch = 19, ylab = "Length (m)", xlab = "Age (weeks)", las = 1, col = alpha(3, 0.5), ylim = c(0, 0.9))
matplot(y = t(RcticG2), type = 'p', lty = 1, pch = 19, las = 1, col = alpha("black", 0.3), ylim = c(0, 0.9), add = TRUE)
