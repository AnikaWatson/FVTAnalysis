...
```{r, echo=FALSE, fig.cap=fig$cap("Yeast Metabolism", "A plot of synthetic data representing the volume of CO~2~ produced over time. Error bars represent standard error from three trials.")}
...
```{r, echo=FALSE, fig.cap=fig$cap("R-ctic Ch-R 1", "A plot demonstrating the shape of the polynimial fit when the number of terms in the approximating polynomial equals the number of data points.")}
