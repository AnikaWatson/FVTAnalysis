...
```{r, fig.cap=fig$cap("Fluvial vs. Adfluial", "A comparison of male and female R-ctic Grayling lengths"), tidy.opts=list(width.cutoff=60), tidy=TRUE}
...
```{r, tidy.opts=list(width.cutoff=60), fig.show= 'hide', tidy=TRUE}
...
```{r, tidy=TRUE, eval=FALSE, tidy.opts=list(width.cutoff=60), tidy=TRUE}
